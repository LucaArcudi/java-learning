...
8. **Chiusura:** dopo che codice e risposte finali sono stati approvati, considera concluso l'esercizio, crea la tua implementazione separata dentro `aireview/` come termine di paragone e scrivi le tue risposte in `aireview/answers.md`. Infine aggiorna `ROADMAP.md`.
